      ...
      <div className="w-full max-w-full mx-auto px-4 sm:px-18 py-10 flex-1">
        ...
        <div className="space-y-6 text-sm sm:text-base text-gray-800 leading-relaxed mt-16">
          ...
          <div className="space-y-6">
            ...
            <p>
              Unyfer (“we,” “our,” or “us”) is committed to protecting your
              privacy. This Privacy Policy explains how your personal
              information is collected, used, and disclosed by Unyfer.
            </p>

            <p>
              This Privacy Policy applies to our app, and its associated
              subdomains (collectively, our “Service”) alongside our
              application, Unyfer. By accessing or using our Service, you
          ...
          <div className="space-y-6">
            ...
            <ul className="list-disc pl-6 space-y-2">
              ...
              <li>
                ...
                “we,” “us,” or “our,” it refers to Unyfer Inc., (12609
                Chinguacousy rd, Caledon, ON, L7C3H2, Canada), that is
                responsible for your information under this Privacy Policy.
              </li>

              <li>
                <strong>Country:</strong> where Unyfer or the owners/founders of
                Unyfer are based, in this case is Canada
              </li>

              <li>
                <strong>Customer:</strong> refers to the company, organization
                or person that signs up to use the Unyfer Service to manage the
              ...
              <li>
                ...
                visit Unyfer and use the services.
              </li>
              ...
              <li>
                ...
                employed by Unyfer or are under contract to perform a service on
              ...
              <li>
                ...
                Unyfer as described in the relative terms (if available) and on
                this platform.
              </li>
          ...
          <div className="space-y-6">
            ...
            <ul className="list-disc pl-6 space-y-2">
              <li>
                ...
                allows the platform to be much more easy to use by the user,
                since accessing your contacts from the app makes you save tons
                of time.
              </li>
          ...
          <div className="space-y-6">
            <h2 className="text-lg sm:text-2xl font-bold text-gray-900">
              When does Unyfer use end user information from third parties?
            </h2>

            <p>
              Unyfer will collect End User Data necessary to provide the Unyfer
          ...
          <div className="space-y-6">
            <h2 className="text-lg sm:text-2xl font-bold text-gray-900">
              When does Unyfer use customer information from third parties?
            </h2>
            ...
            <p>
              ...
              to show interest in becoming a Unyfer customer, we receive
              information from a third party that provides automated fraud
              detection services to Unyfer.
            </p>
          ...
          <div className="space-y-6">
            ...
            <p>
              ...
              whether you have visited the app in a shared location, and type of
              the device used to visit the app. They may aggregate information
              about our advertising and what you see on the app and then provide
          ...
          <div className="space-y-6">
            ...
            <p>
              Unyfer will collect personal information that you submit to us. We
          ...
          <div className="space-y-6">
            ...
            <p>
              ...
              Unyfer to you and fulfill the purposes described in this policy.
          ...
          <div className="space-y-6">
            ...
            <p>
              ...
              information you transmit to Unyfer or guarantee that your
          ...
          <div className="space-y-6">
            ...
            <p>
              Unyfer is incorporated in Canada. Information collected via our
              ...
              regulating the use and transfer of such data.
            </p>
          ...
          <div className="space-y-6">
            <h2 className="text-lg sm:text-2xl font-bold text-gray-900">
              Is the information collected through the Unyfer Service secure?
            </h2>
            ...
            <p>
              ...
              and correctly use your information.
            </p>
          ...
          <div className="space-y-6">
            ...
            <p>
              ...
              information Unyfer collects depend on your relationship with
              Unyfer. Personnel may update or correct their information as
          ...
          <div className="space-y-6">
            ...
            <p>
              If you are a Unyfer worker or applicant, we collect information
          ...
          <div className="space-y-6">
            ...
            <p>
              ...
              substantially all of the assets of Unyfer or any of its Corporate
              Affiliates (as defined herein), or that portion of Unyfer or any
          ...
          <div className="space-y-6">
            ...
            <p>
              ...
              common control with Unyfer, whether by ownership or otherwise.
            </p>
          ...
          <div className="space-y-6">
            ...
            <p>
              This Privacy Policy is governed by the laws of Canada without
            ...
            <p>
              By using Unyfer or contacting us directly, you signify your
            ...
            <p>
              Continued use of the app, direct engagement with us, or following
          ...
          <div className="space-y-6">
            ...
            <p>
              ...
              how it's being used. By using our Unyfer, registering an account,
          ...
          <div className="space-y-6">
            ...
            <p>
              ...
              Unyfer. We are not responsible for the content, accuracy or
            ...
            <p>
              ...
              website’s own rules and policies.
            </p>
          ...
          <div className="space-y-6">
            ...
            <p>
              Unyfer uses "Cookies" to identify the areas of our app that you
            ...
            <p>
              ...
              app but are non-essential to their use. However, without these
              ...
              you visit the app as we would not be able to remember that you had
            ...
            <p>
              ...
              functionality on our app correctly or at all. We never place
          ...
          <div className="space-y-6">
            ...
            <p>
              You should also be aware that you may also lose some saved
          ...
          <div className="space-y-6">
            ...
            <p>
              ...
              through our Service) before we make changes to this Privacy Policy
            ...
            <p>
              ...
              updated Privacy Policy. If you do not want to agree to this or any
          ...
          <div className="space-y-6">
            ...
            <p>
              You acknowledge and agree that Unyfer shall not be responsible for
            ...
            <p>
              Unyfer does not assume and shall not have any liability or
          ...
          <div className="space-y-6">
            ...
            <p>
              ...
              just the EU-based businesses and EU residents.
            </p>

            <p>
              Our customers’ data is important irrespective of where they are
          ...
          <div className="space-y-6">
            ...
            <p>
              ...
              genetic data, biometric data, IP addresses, physical address,
          ...
          <div className="space-y-6">
            ...
            <p>
              ...
              and imposing greater fines for breach.
            </p>

            <p>
              Beyond these facts it's simply the right thing to do. At Unyfer we
          ...
          <div className="space-y-6">
            ...
            <p>
              ...
              rights requirements of GDPR. Unyfer processes or stores all
              personal data in fully vetted, DPA compliant vendors.
            </p>
            ...
            <p>
              ...
              retrieve and remove personal data.
            </p>

            <p>
              We got you! We've been set up as self service from the start and
              have always given you access to your data and your customers data.
              Our customer support team is here for you to answer any questions
          ...
          <div className="space-y-6">
            ...
            <ul className="list-disc pl-6 space-y-2">
              <li>Via Email: Help@Unyfer.com</li>
              <li>
                Via this Link:{" "}
                <a
                  href="https://unyfer.com/"
                  target="_blank"
